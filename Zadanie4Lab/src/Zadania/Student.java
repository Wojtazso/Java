...
public class Student {
    ...
    public Student(String imie, String nazwisko, String nazwa_spec, int nr_ind, int rok_stud) {
        this.imie=" ";
        this.nazwisko=" ";
        this.nazwa_spec=" ";
        this.nr_ind=0;
    ...
    public Student(String imie, String nazwisko, int nr_ind) {
        this.imie = imie;
    ...
    public Student(){}
public Student(String nazwa_spec, int rok_stud, int nrInd){this.nazwa_spec=nazwa_spec;this.rok_stud=rok_stud;}
    public void pokdan(){
